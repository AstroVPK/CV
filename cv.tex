...
At Colfax International, I conduct research on new HPC technologies. I have

\begin{itemize}
    \item provided HPC code-modernization consulting for a client in the energy sector leading to a 35\% speed-up in the client code-base.
\end{itemize}
...
\begin{itemize}
  \item ``Science-driven Optimization of the LSST Observing Strategy", \href{https://github.com/LSSTScienceCollaborations/ObservingStrategy}{GitHub Repository}, 2016
	\item $\mathbf{^{*}}$``Extracting Information from AGN Variability", \href{https://arxiv.org/abs/1607.04299}{\textit{submitted to MNRAS}}, 2017
