...
\item High Performance Computing (HPC) Research Engineer ({\it March 2017 - present}) \\

I conduct research on new HPC technologies and provide HPC consulting services to clients across a broad range of industries. I have

\begin{itemize}
    \item provided HPC code-modernization consulting for a client in the oil \& gas sector leading to a 6X speed-up in the client code-base.
    \item re-factored client codebase for a large Computational Fluid Dynamics simulation to enable domain-decomposition.
\end{itemize}
